...
@section('content')
    <div class="admin-page-header">
        <div>
            ...
            <p class="admin-page-subtitle">Tambahkan produk baru ke marketplace desa</p>
        </div>
        ...
        <div class="admin-form-grid">
            <div class="admin-card">
                ...
                <div class="admin-form-group">
                    ...
                    <textarea name="description" rows="8" class="admin-input" placeholder="Jelaskan bahan, ukuran, keunggulan produk...">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="admin-form-sidebar">
                ...
                <div class="admin-card">
                    <h3 class="admin-card__title">Penjual & Kategori</h3>

                    <div class="admin-form-group">
                        <label>Penjual / UMKM</label>
                        <select name="seller_profile_id" class="admin-input" required>
                            <option value="">— Pilih Penjual —</option>
                            @foreach ($sellers as $seller)
                                <option value="{{ $seller->id }}" @selected(old('seller_profile_id') == $seller->id)>{{ $seller->business_name }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="admin-card">
                    ...
                    <div class="admin-form-group">
                        <div class="admin-upload">
                            <img id="preview-create-product" class="admin-upload__preview" style="display:none;">
                            <div id="preview-create-product-placeholder" class="admin-upload__placeholder">
                        ...
                        <input type="file" name="thumbnail" accept="image/*" class="admin-input" data-image-preview="preview-create-product" required>
