...
<header class="admin-topbar">
    ...
    <div class="admin-topbar__left">
        ...
        <h2 class="admin-topbar__page-title">@yield('page-title', 'Dashboard')</h2>
    </div>
    ...
    <div class="admin-topbar__right">
        ...
        <div class="admin-topbar__user">
            ...
            <div class="admin-topbar__user-info">
                <span class="admin-topbar__user-name">{{ $sellerName }}</span>
                <span class="admin-topbar__user-email">Pemilik UMKM</span>
            </div>
        </div>
    </div>
